...
public class nearestNeighbour {
	...
	public static void main(String[] args) {
		...
		int[][] ans = getAllNearestNeighbour(nums, 3);
		prnt2dArry(ans);
	 ...
	 * @param nums
	 * @param k
	 * @return - the nearest neighbour size and difference, the index number
	 * of the array corresponds with the index of the original array
	 */
	 ...
	 * @param k
	 * @param pos
	 * @return [size of kth neighbour, difference]
	 */
